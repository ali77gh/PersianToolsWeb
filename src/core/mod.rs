    ...
    pub static ref TOOLS: [Tool; 40] = {
        [
            ...
            Tool::new(
                ...
                "وجود حروف ویژه ی عربی", vec!["عربی","حروف ویژه"],"حروف ویژه ی عربی (ك یا ي یا ی)"
            ),
            Tool::new(
                "is_arabic","arabic_chars",is_arabic, "ملك",
                "تمامیت حروف ویژه عربی", vec!["عربی","حروف ویژه"],"حروف ویژه ی عربی (ك یا ي یا ی)"
            ),
            Tool::new(
                "to_arabic","arabic_chars",to_arabic, "ملک",
                "تبدیل به حروف ویژه عربی", vec!["عربی","حروف ویژه"],"حروف ویژه ی عربی (ك یا ي یا ی)"
            ),
            Tool::new(
            ...
            Tool::new(
                ...
                "تبدیل عدد فارسی به انگلیسی", vec!["عدد","اعداد","تبدیل"],""
            ),
            Tool::new(
                "en_to_fa","digits",en_to_fa, "1234",
                "تبدیل عدد انگلیسی به فارسی", vec!["عدد","اعداد","تبدیل"],""
            ),
            Tool::new(
                "en_to_ar","digits",en_to_ar, "1234",
                "تبدیل عدد انگلیسی به عربی", vec!["عدد","اعداد","تبدیل"],""
            ),
            Tool::new(
                "ar_to_en","digits",ar_to_en, "٤٥",
                "تبدیل عدد عربی به انگلیسی", vec!["عدد","اعداد","تبدیل"],""
            ),
            Tool::new(
                "fa_to_ar","digits" ,fa_to_ar, "۴۵",
                "تبدیل عدد فارسی به عربی", vec!["عدد","اعداد","تبدیل"],""
            ),
            Tool::new(
                "ar_to_fa","digits",ar_to_fa, "٤٥",
                "تبدیل عدد عربی به فارسی", vec!["عدد","اعداد","تبدیل"],""
            ),
            Tool::new(
                "extract_card_number","extract_card_number",extract_card_number, "شماره کارتم رو برات نوشتم: ۵۰۲۲-2910-7۰۸۷-۳۴۶۶",
                "استخراج شماره کارت", vec!["بانک"],"در متن وارد شده شماره کارت پیدا میکند و به حروف انگلیسی تبدیل میکند"
            ),
            Tool::new(
            ...
            Tool::new(
                ...
                "بانک از کارت", vec![""],"شماره کارت را از ورودی گرفته و بانک مربوط به آن را نمایش میدهد"
            ),
            Tool::new(
                "get_city_by_iran_national_id","get_city_by_iran_national_id",get_city_by_iran_national_id, "0021000000",
                "کد ملی شهر", vec![""],"کد ملی را از ورودی گرفته و شهر مربوط به آن را نمایش میدهد"
            ),
            Tool::new(
                "get_province_by_iran_national_id","get_province_by_iran_national_id",get_province_by_iran_national_id, "0021000000",
                "کد ملی استان", vec![""],"کد ملی را از ورودی گرفته و استان مربوط به آن را نمایش میدهد"
            ),
            Tool::new(
                "remove_half_space","remove_half_space",remove_half_space, "نمی‌خواهی درخت‌ها را ببینیم؟",
                "حذف نیم فاصله", vec![""],"نیم فاصله ها را با فاصله جایگزین میکند"
            ),
            Tool::new(
                "add_half_space","add_half_space",add_half_space, "نمی خواهی درخت ها را ببینیم؟",
                "نیم فاصله", vec![""],"در صورت نیاز فاصله ها را با نیم فاصله جایگزین میکند"
            ),
            Tool::new(
                "verify_iranian_legal_id","verify_iranian_legal_id",verify_iranian_legal_id, "10380284790",
                "شناسه حقوقی", vec![""],"شناسه حقوقی را اعتبار سنجی میکند"
            ),
            Tool::new(
                "verify_iranian_national_id","verify_iranian_national_id",verify_iranian_national_id, "68415941",
                "کد ملی", vec![""],"این ابزار کد ملی را اعتبار سنجی میکند"
            ),
            Tool::new(
                "get_plate_type","get_plate_type",get_plate_type, "12ب145ایران47",
                "نوع پلاک", vec![""],"این ابزار پلاک ماشین یا موتور را از ورودی خوانده و نوع آن را نمایش میدهد"
            ),
            Tool::new(
                "get_plate_province","get_plate_province",get_plate_province, "12ب145ایران47",
                "استان پلاک", vec![""],"این ابزار پلاک ماشین یا موتور را از ورودی خوانده و استان آن را نمایش میدهد"
            ),
            Tool::new(
                "get_plate_category","get_plate_category",get_plate_category, "12ب145ایران47",
                "دسته بندی پلاک", vec![""],"این ابزار پلاک ماشین یا موتور را از ورودی خوانده و دسته بندی آن را نمایش میدهد"
            ),
            Tool::new(
                "number_to_words","number_to_words",number_to_words, "300123987",
                "عدد به حروف", vec![""],"عدد رو به حروف تبدیل میکند"
            ),
            Tool::new(
                "has_persian","persian_chars",has_persian, "abcdefمghij",
                "وجود حروف ویژه ی فارسی", vec!["فارسی","حروف ویژه"],""
            ),
            Tool::new(
                "is_persian","persian_chars",is_persian, "ابپتثaجچه",
                "تمامیت حروف ویژه فارسی", vec!["فارسی","حروف ویژه"],""
            ),
            Tool::new(
                "to_persian","persian_chars",to_persian_chars, "ملك",
                "تبدیل به حروف ویژه فارسی", vec!["فارسی","حروف ویژه"],""
            ),
            Tool::new(
                "is_phone_valid","phone_number",is_phone_valid, "09121111111",
                "اعتبار سنجی شماره تلفن", vec!["موبایل"],""
            ),
            Tool::new(
                "get_operator_prefix","phone_number",get_operator_prefix, "09121111111",
                "پیش شماره", vec!["موبایل"],"شماره تلفن همراه را از ورودی گرفته و پیش شماره را نمایش میدهد"
            ),
            Tool::new(
                "get_phone_operator","phone_number",get_phone_operator, "09121111111",
                "اپراتور از شماره تلفن", vec!["موبایل"],"شماره تلفن همراه را از ورودی گرفته و اپراتور را نمایش میدهد"
            ),
            Tool::new(
                "get_phone_province","phone_number",get_phone_province, "09121111111",
                "استان شماره تلفن", vec!["موبایل"],"شماره تلفن همراه را از ورودی گرفته و در صورت امکان استان مربوط به آن را نمایش میدهد"
            ),
            Tool::new(
                "is_sheba_valid","sheba",is_sheba_valid, "IR012345678A01234567890123",
                "اعتبار سنجی شبا", vec!["بانک"],"شماره شبا را از ورودی خوانده و ان را اعتبار سنجی میکند"
            ),
            Tool::new(
                "sheba_to_bank_name","sheba",sheba_to_bank_name, "IR012345678A01234567890123",
                "بانک از شماره شب(انگلیسی)", vec!["بانک"],"شماره شبا را از ورودی خوانده و نام انگلیسی بانک مربوط به آن را نمایش میدهد"
            ),
            Tool::new(
                "sheba_to_persian_bank_name","sheba",sheba_to_persian_bank_name, "IR012345678A01234567890123",
                "(فارسی)بانک از شماره شبا", vec!["بانک"],"شماره شبا را از ورودی خوانده و نام فارسی بانک مربوط به آن را نمایش میدهد"
            ),
            // Tool::new(
            ...
            Tool::new(
                "words_to_number","words_to_number",words_to_number, "6037701689095443",
